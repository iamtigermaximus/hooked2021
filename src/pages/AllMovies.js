...
const AllMovies = () => {
    ...
    useEffect(() => {
        setLoading(true)
        axios
        .get(`https://api.themoviedb.org/3/discover/movie?&api_key=89112843133b22b96a96ab6de6cc8f5f&page=${page}`)
        .then(response=>{
            setLoading(false)
    ...
    return (
        ...
        <div className="popular-container title-page pb-5">
            <div className="title-page-heading text-light text-center mt-4">
                ...
                {loading ? <div className="text-center" ><Loader type ="ThreeDots" color="#00BFFF" height={100} width={100} timeout={3000} visible={true}/></div> :
